...
class ModelDeployer:
    ...
    def deploy_local(self, model_name, model_path=None):
        ...
        try:
            ...
            signature = infer_signature(self.input_example, self.model.automl.predict(self.input_example))

            with mlflow.start_run() as run:
                # Log the model with signature and input example
                mlflow.lightgbm.log_model(self.model.automl.model, model_name, signature=signature, input_example=self.input_example)
